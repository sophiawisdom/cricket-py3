...
def _enable_libord():
    from . import macho.loadcommands.dylib

def _enable_vmaddr():
    from . import macho.vmaddr
    from . import macho.loadcommands.segment

def _enable_symbol():
    from . import macho.symbol
    from . import macho.loadcommands.symtab
    from . import macho.loadcommands.dysymtab
    from . import macho.loadcommands.dyld_info
    from . import macho.sections.symbol_ptr

def _enable_encryption():
    from . import macho.loadcommands.encryption_info

def _enable_strings():
    from . import macho.sections.cstring
    from . import macho.sections.cfstring

def _enable_objc():
    _enable_symbol()
    from . import macho.sections.objc.classlist
    from . import macho.sections.objc.protolist
    from . import macho.sections.objc.catlist
